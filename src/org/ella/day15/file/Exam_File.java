...
public class Exam_File {
	public static void main(String[] args) {
		File folderMake = new File("src/org/ella/day15/file/sample");
	...
	public void fileMake() throws IOException {
		File fileMake = new File("src/org/ella/day15/file/sample.txt"); // 파일만 생성
		if (!fileMake.exists()) {
	...
	public void fileBasic() {
		File file = new File("C:\\temp\\copyimg.jpg"); // 객체화했기 때문에 메소드 사용 가능
